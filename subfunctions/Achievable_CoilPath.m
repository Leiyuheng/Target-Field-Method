...
CoilPath_Achievable = [x , y , z];
CoilPath_Achievable = [CoilPath_Achievable;CoilPath_Achievable(1,:)];
...
view(30,30);                         % 俯视 30° × 仰视 30°

% 点-线绘制：'-o' = 连线 + 圆点
plot3(CoilPath_Achievable(:,1), ...
      CoilPath_Achievable(:,2), ...
      CoilPath_Achievable(:,3), ...
      '-o', ...                     % 连线+圆点
      'MarkerSize',3, ...
      'MarkerFaceColor',[0.2 0.5 0.8], ...
      'MarkerEdgeColor','k', ...
      'LineWidth',1.2, ...
      'Color',[0.2 0.5 0.8]);       % ← 加分号

% 起点 / 终点强调
plot3(CoilPath_Achievable(1,1),  CoilPath_Achievable(1,2),  CoilPath_Achievable(1,3), ...
      'go','MarkerSize',9,'LineWidth',1.5,'HandleVisibility','off');   % ← 加分号
plot3(CoilPath_Achievable(end,1),CoilPath_Achievable(end,2),CoilPath_Achievable(end,3), ...
      'ks','MarkerSize',9,'LineWidth',1.5,'HandleVisibility','off');   % ← 加分号
